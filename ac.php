...
<div id="wrapper_outer">
	...
	<div class="top_right">
        ...
        <div id="content_wrapper">
           ...
           <img width="250" height="60" src="images/ci.gif"/>
		  <div class="center_title_bar"><font color = "green" size="4">Architecture & Civil</font></div>
		  <br>
        <div class="center_content">
		
		 <?php
			$query = 'SELECT * FROM items WHERE catid = 5 ;';
			$result = mysqli_query($db, $query);
