...
<div id="wrapper_outer">
	...
	<div class="top_right">
        ...
        <div id="content_wrapper">
           ...
           <img width="250" height="60" src="images/cs.gif"/>
		  <div class="center_title_bar"><font color = "green" size="4">Computer Science</font></div>
		  <br>
        <div class="center_content">
			  <?php
		$query = 'SELECT * FROM items WHERE catid = 2 ;';
		$result = mysqli_query($db, $query);
